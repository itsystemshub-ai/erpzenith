...
{/* Comentario remanente */}
<div className="md:col-span-5 bg-stone-900 p-8 flex flex-col justify-between asymmetric-cut relative overflow-hidden min-h-[500px]">
<div className="absolute inset-0 opacity-20">
<img className="w-full h-full object-cover" data-alt="Close-up of industrial heavy machinery gear components with metallic sheen and dark moody atmosphere" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDzoGEmAksW7lTtLojjc3GJclts9iQUWtsZVhS_kMD3aDxxYSjcJ8egT8Zj7zluD5sSZpwtZ3QU4drvurZ93k0GeyCacH3XjISLUXURs00GWhlXQ1PMJVeXsaydOCi85HKOVGm5hpNkU_TNpz5uD_j07ck2uFSVMrmLjSSuO9tZYXmtViqvsXpVlCO1oVJU8jWzFsCY3_2zg3J4Tc7TyFf7i5KrxQX3uhTDcPrykWUtzPbos73Jkq9lQ7OkD9UDqxTc5Rt2J8Tl4a0"/>
</div>
...
{/* Comentario remanente */}
<footer className="mt-12 w-full max-w-4xl flex flex-col md:flex-row justify-between items-center gap-6 px-4">
<div className="flex flex-col items-center md:items-start">
<span className="font-headline font-black text-zinc-700 tracking-tighter text-xl">RIF J-40308741-5</span>
...
<p className="font-headline text-stone-300 font-medium">+58 212-CORE-00</p>
</div>
<div className="h-8 w-px bg-zinc-800"></div>
<div className="text-right">
<p className="font-label text-[10px] font-bold text-stone-500 uppercase tracking-widest">Global Ops</p>
<p className="font-headline text-stone-300 font-medium text-xs">admin.lacima@industrial.ve</p>
</div>
</div>
</footer>
{/* Comentario remanente */}
